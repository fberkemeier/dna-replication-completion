...
DNAscape integrates experimental replication datasets such as Repli-seq, SNS-seq, OK-seq, and related assays into a unified kinetic representation, enabling genome-wide reconstruction of DNA replication programmes and inference of key replication features including origin firing rates and efficiency, fork directionality, fork speed distributions, inter-origin distances, and replication timing progression. Beyond data integration, it supports hypothesis-driven modelling of DNA replication dynamics, allowing users to simulate alternative mechanistic scenarios, test assumptions about origin firing or fork behaviour, and quantify how changes in replication kinetics reshape genome-wide replication dynamics, providing a reusable framework for quantitative inference and mechanistic exploration of DNA replication.
